 ...
 * @author 84343
 */
public class PanelActionMatHang extends javax.swing.JPanel {

    /**
     * Creates new form PanelActionMatHang
     */
    public PanelActionMatHang() {
        initComponents();
    }

    public void initEvent(TableActionEventMatHang event, int row) {//
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cmdXoa, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
