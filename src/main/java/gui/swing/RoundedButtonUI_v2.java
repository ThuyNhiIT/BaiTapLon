 ...
 */
public class RoundedButtonUI_v2 extends javax.swing.plaf.basic.BasicButtonUI {
    @Override
...
//		Color brandColor1 = new Color(210,180,140);

		Graphics2D g2 = (Graphics2D) g;
		g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
		GradientPaint gp = new GradientPaint(3, 3, Color.CYAN, 3, height, Color.BLACK);
		g2.setPaint(gp);
