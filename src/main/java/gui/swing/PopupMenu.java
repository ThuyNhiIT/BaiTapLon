...
public class PopupMenu extends javax.swing.JDialog {
    ...
    /**
     * Khởi tạo một PopupMenu mới.
     *
     * @param parent        Frame cha (được đưa ra).
     * @param index         Chỉ số của menu.
     * @param eventSelected Sự kiện khi một mục menu được chọn.
     * @param subMenu       Danh sách các mục con của menu.
     */
    public PopupMenu(java.awt.Frame parent, int index, EventMenuSelected eventSelected, String... subMenu) {
        ...
        panel.setLayout(new MigLayout("fill, wrap", "8[fill, 120]0", "0[30, fill]0[30, fill]0"));
        ...
        for (String st : subMenu) {
            ...
            panel.add(item);
            setSize(new Dimension(155, 35 * subMenu.length));
        }
